...
agonist_3threshold <- exp(agonist_2mean+agonist_3std)
...
AR_agonist_venndiagram <- venn.diagram(list(agonist1_top_listforvenndiagram=agonist1_top_listforvenndiagram, agonist2_top_listforvenndiagram=agonist2_top_listforvenndiagram, agonist3_top_listforvenndiagram=agonist3_top_listforvenndiagram),
...
#wow that was v ugly, maybe I'll just make a summary table?
...
```{r eval=FALSE}
##Needs Update after I figure out everything I want to do first with AR##
