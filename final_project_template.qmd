...
#cross validation 
#set.seed(1234)
#ar_bla_agonist_p1.folds <- vfold_cv(ar_bla_agonist_p1.2, v=10)
#ar_bla_agonist_p1.folds

#set.seed(1234)
#ar_bla_agonist_p1.cv <-
#  rf_workflow |>
#  fit_resamples(ar_bla_agonist_p1.folds, 
#                control = control_resamples(save_pred = TRUE)) #18 mins
...
ar_bla_antagonist_p1.2 <- ar_bla_antagonist_p1 |>
  mutate(across(-1, as.factor)) |>
  mutate(target = factor(target, levels = c(0, 1), labels = c("0", "1")))
head(ar_bla_antagonist_p1.2)

#Making model
ar_bla_antagonist_p1.rf_cls_fit <- rf_cls_spec |>
  fit(target ~ ., data = ar_bla_antagonist_p1.2)
...
#cross validation // not run yet bc wait time is longg
#set.seed(1234)
#ar_bla_antagonist_p1.folds <- vfold_cv(ar_bla_antagonist_p1.2, v=10)
#ar_bla_antagonist_p1.folds
...
ar_mda_kb2_luc_agonist_p1.2 <- ar_mda_kb2_luc_agonist_p1 |>
  mutate(across(-1, as.factor)) |>
  mutate(target = factor(target, levels = c(0, 1), labels = c("0", "1")))
head(ar_mda_kb2_luc_agonist_p1.2)

#Making model
ar_mda_kb2_luc_agonist_p1.rf_cls_fit <- rf_cls_spec |>
  fit(target ~ ., data = ar_mda_kb2_luc_agonist_p1.2)
...
#cross validation // not run yet bc wait time is longg
#set.seed(1234)
#ar_mda_kb2_luc_agonist_p1.folds <- vfold_cv(ar_mda_kb2_luc_agonist_p1.2, v=10)
#ar_mda_kb2_luc_agonist_p1.folds
...
ar_mda_kb2_luc_agonist_p3.2 <- ar_mda_kb2_luc_agonist_p3 |>
  mutate(across(-1, as.factor)) |>
  mutate(target = factor(target, levels = c(0, 1), labels = c("0", "1")))
head(ar_mda_kb2_luc_agonist_p3.2)

#Making model
ar_mda_kb2_luc_agonist_p3.rf_cls_fit <- rf_cls_spec |>
  fit(target ~ ., data = ar_mda_kb2_luc_agonist_p3.2)
...
#cross validation // not run yet bc wait time is longg
#set.seed(1234)
#ar_mda_kb2_luc_agonist_p3.folds <- vfold_cv(ar_mda_kb2_luc_agonist_p3.2, v=10)
...
ar_mda_kb2_luc_antagonist_p1.2 <- ar_mda_kb2_luc_antagonist_p1 |>
  mutate(across(-1, as.factor)) |>
  mutate(target = factor(target, levels = c(0, 1), labels = c("0", "1")))
head(ar_mda_kb2_luc_antagonist_p1.2)

#Making model
ar_mda_kb2_luc_antagonist_p1.rf_cls_fit <- rf_cls_spec |>
  fit(target ~ ., data = ar_mda_kb2_luc_antagonist_p1.2)
...
#cross validation // not run yet bc wait time is longg
#set.seed(1234)
#ar_mda_kb2_luc_antagonist_p1.folds <- vfold_cv(ar_mda_kb2_luc_antagonist_p1.2, v=10)
...
ar_mda_kb2_luc_antagonist_p2.2 <- ar_mda_kb2_luc_antagonist_p2 |>
  mutate(across(-1, as.factor)) |>
  mutate(target = factor(target, levels = c(0, 1), labels = c("0", "1")))
head(ar_mda_kb2_luc_antagonist_p2.2)

#Making model
ar_mda_kb2_luc_antagonist_p2.rf_cls_fit <- rf_cls_spec |>
  fit(target ~ ., data = ar_mda_kb2_luc_antagonist_p2.2)
...
#cross validation // not run yet bc wait time is longg
#set.seed(1234)
#ar_mda_kb2_luc_antagonist_p2.folds <- vfold_cv(ar_mda_kb2_luc_antagonist_p2.2, v=10)
